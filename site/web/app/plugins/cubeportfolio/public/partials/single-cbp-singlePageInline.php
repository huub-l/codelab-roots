    ...
    <?php while (have_posts()): the_post();
        ...
        <article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
            <div class="cbp-l-inline">
                ...
                <div class="cbp-l-inline-right" <?php echo (count($images))? '' : 'style="width:100%;padding-left:0;"' ?>>
                    ...
                    <?php if ($metadata['cbp_project_link'][0]): ?>
                        <div class="cbp-l-inline-view-wrap">
                            <a href="<?php echo $metadata['cbp_project_link'][0];?>" target="<?php echo $metadata['cbp_project_link_target'][0];?>" class="cbp-l-inline-view" <?php echo ($metadata['cbp_project_link_nofollow'][0] == 'on' ? 'rel="nofollow"' : ''); ?>><?php _e('VIEW PROJECT', CUBEPORTFOLIO_TEXTDOMAIN); ?></a>
                        </div>
                    <?php endif; ?>
