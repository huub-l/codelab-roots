...
class CubePortfolioBackend {
    ...
    public function register_assets() {
        ...
        // ADMIN
         ...
         wp_register_style( 'cubeportfolio-admin-css', CUBEPORTFOLIO_URL . 'admin/css/main.min-1.16.3.css', false, CUBEPORTFOLIO_VERSION, 'all' );

        
         wp_register_script( 'cubeportfolio-admin-js', CUBEPORTFOLIO_URL . 'admin/js/main.min-1.16.3.js', array('jquery', 'jquery-ui-draggable', 'jquery-ui-sortable'), CUBEPORTFOLIO_VERSION, true );
